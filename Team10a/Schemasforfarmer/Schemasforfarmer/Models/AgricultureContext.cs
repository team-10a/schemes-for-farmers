        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Bidding>(entity =>
            {
                entity.HasKey(e => e.BiddingId)
                   .HasName("PK__Bidding__B1AE7D4712C7C1DC");
            ...
            modelBuilder.Entity<CropType>(entity =>
            {
                entity.HasKey(e => e.CropTypeId)
                    .HasName("PK__CropType__503F4B64EEA1D337");
            ...
            modelBuilder.Entity<LoginInfo>(entity =>
            {
                ...
                entity.HasOne(d => d.User)
                    .WithMany()
                    .HasForeignKey(d => d.UserId)
                    .HasConstraintName("FK__LoginInfo__UserI__00200768");

                entity.HasOne(d => d.UserType)
                    .WithMany()
                    .HasForeignKey(d => d.UserTypeId)
                    .HasConstraintName("FK__LoginInfo__UserT__01142BA1");
            });
            ...
            modelBuilder.Entity<Sell>(entity =>
            {
                entity.HasKey(e => e.SellId)
                    .HasName("PK__Sell__B35F66DF970706B3");
